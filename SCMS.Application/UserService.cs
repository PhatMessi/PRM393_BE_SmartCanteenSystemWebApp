...
namespace SCMS.Application
{
    ...
    public class UserService
    {
        ...
        private string GenerateRandomPassword()
        {
            ...
            // Sử dụng RandomNumberGenerator.GetInt32 (Chuẩn bảo mật mới)
            ...
            // Shuffle password để ngẫu nhiên vị trí
            return new string(password.OrderBy(c => RandomNumberGenerator.GetInt32(int.MaxValue)).ToArray());
        }
